...
namespace Test_Logger
{
    public partial class frmSetting : Form
    {
        ...
        private void Setting_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Properties.Settings.Default.mssql != "") { 
                    ...
                    //txtLine.Text = Properties.Settings.Default.line;
                    txtLineNumber.Value= Properties.Settings.Default.line;
        ...
        private void btnSetting_Click(object sender, EventArgs e)
        {
            ...
            Properties.Settings.Default.line = Convert.ToInt32(txtLineNumber.Value);
